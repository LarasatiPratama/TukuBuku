...
<center><form action="process-edit-book.php" method="POST" enctype="multipart/form-data">
<table width="400px">
    ...
    <tr><td align="center" valign="middle">Image</td>
        <td align="center" valign="middle" style="padding: 5px 5px 5px 5px"><?php include("image.php"); ?><br><input type="file" name="gambar" value="<?php echo $data['gambar']?>"></td></tr>
