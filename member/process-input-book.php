...
$sql = "INSERT INTO buku (isbn, judul, penulis, edisi, copyright, deskripsi, penerbit, gambar, harga, kategori) VALUES ('".$_POST['isbn']."','".$_POST['title']."','".$_POST['author']."','".$_POST['edition']."','".$_POST['copyright']."','".$_POST['description']."','".$_POST['publisher']."','$fileName','".$_POST['price']."','".$_POST['category']."')"; 
